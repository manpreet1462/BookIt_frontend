    ...
    <div className="flex gap-2 sm:gap-3">
      {appliedPromo ? (
        <button
          ...
          className="flex-1 sm:flex-none px-4 sm:px-8 py-3 bg-red-600 text-white font-medium rounded-md hover:bg-red-700 transition-colors text-sm sm:text-base"
        >
          Remove
        </button>
      ) : (
        <button
          ...
          className={`flex-1 sm:flex-none px-4 sm:px-8 py-3 font-medium rounded-md transition-colors text-sm sm:text-base ${
            promoLoading
